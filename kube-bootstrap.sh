...
sudo chmod +x kube-apiserver kube-controller-manager kube-proxy kube-scheduler kubectl kubelet
sudo mv kube-apiserver kube-controller-manager kube-proxy kube-scheduler kubectl kubelet /usr/local/bin/
...
sudo mv audit-policy.yaml /etc/kubernetes/audit-policy.yaml
...
sudo chmod 644 kube.kubeconfig
